...
I also want to call out the non-Spinel contributors to `rv` here. The community that formed around `rv` and started contributing to it has been amazing. In particular, I want to thank [Samuel Giddins](https://github.com/segiddins) for work on gem and gemspec parsing and Ruby shell integration, [Adam Chalmers](https://github.com/adamchalmers) for work on parsing Gemfile.lock and installing gems, and [Eric Case](https://github.com/case) for work on Windows and Alpine compatibility. We wouldn't have made it anywhere close to this far without all of your help.
