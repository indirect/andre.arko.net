...
Before you learn Rails, you'll need to have a pretty good grasp of some other things. The biggest ones are HTML/XHTML and CSS, the foundational standards of the world wide web. A good place to start learning about them is at the Mozilla Foundation's "introduction to HTML":https://developer.mozilla.org/en-US/docs/HTML/Introduction and "CSS tutorial":https://developer.mozilla.org/en-US/docs/CSS/Getting_Started. Once you've completed those tutorials, you should have enough of an understanding to experiment, learn things, and move on to Ruby and Rails.
